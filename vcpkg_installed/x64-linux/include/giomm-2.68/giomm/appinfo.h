...
public:
  ...
  /** Gets a list of recommended AppInfos for a given content type, i.e.\ those applications which claim to support the given content type exactly,
  ...
  /** Gets a list of fallback AppInfos for a given content type, i.e.\ those applications which claim to support the given content type
