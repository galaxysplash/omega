 ...
 *  @a G_UNICODE_BREAK_AKSARA_PRE_BASE (AP). Since: 2.80
 *  @a G_UNICODE_BREAK_AKSARA_START (AS). Since: 2.80
 *  @a G_UNICODE_BREAK_VIRAMA_FINAL (VF). Since: 2.80
 *  @a G_UNICODE_BREAK_VIRAMA (VI). @newin{2,80}
 */
